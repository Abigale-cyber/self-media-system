...
DEFAULT_SKILL_SCRIPTS = Path.home() / ".codex" / "skills" / "wechat-article-workflow" / "scripts"
SKILL_SCRIPTS = Path(os.environ.get("WECHAT_ARTICLE_WORKFLOW_SCRIPTS", DEFAULT_SKILL_SCRIPTS)).expanduser().resolve()
...
try:
    ...
    raise SystemExit(
        "Missing wechat-article-workflow scripts. Install that skill, or set "
        "WECHAT_ARTICLE_WORKFLOW_SCRIPTS=/path/to/wechat-article-workflow/scripts."
    ) from exc
