...
```
数字分身 → 生成选题/爆款拆解 → 内容大纲 → 大纲扩写/口播脚本/生成配图 → 内容审稿 → 数据复盘
```
...
```
digital-avatar → topic-generator → content-outline-builder → outline-expander/voice-script-writer → adversarial-content-review → data-analysis
```
